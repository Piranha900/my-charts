    ...
    spec:
      ...
      - image: "{{ .Values.image.name }}:{{ default .Chart.AppVersion .Values.image.tag }}"
        ...
        args:
          ...
          {{- end }}
          {{- end }}
          {{- if .Values.tracing.jaegerVars }}
          - "--tracing.jaeger=true"
          - "--tracing.jaeger.samplingServerURL={{ .Values.tracing.jaegerVars.samplingServerUrl }}"
          - "--tracing.jaeger.localAgentHostPort={{ .Values.tracing.jaegerVars.localAgentHostPort }}"
          {{- end }}
